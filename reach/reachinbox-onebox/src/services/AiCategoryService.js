...
exports.AiCategoryService = void 0;
...
`;
            ...
            if (!response.ok) {
                ...
                logger_1.logger.error(`Gemini API error: ${response.status} ${errorText}`);
            ...
            if (category) {
                try {
                    ...
                    logger_1.logger.error('Error parsing Gemini API response:', parseError);
                }
            }
            logger_1.logger.warn('Could not extract category from Gemini API response, using default');
            return 'Uncategorized';
        }
        catch (error) {
            logger_1.logger.error('Error categorizing email:', error);
            return 'Uncategorized';
        }
    }
}
exports.AiCategoryService = AiCategoryService;
//# sourceMappingURL=AiCategoryService.js.map